...
if CLIENT then
	...
	local function chatMessage( args ) 
		chat.AddText( Color( 0, 255, 0 ), "Loadout: ", Color( 255, 255, 255 ), args)
	end
	...
	function openLoadoutMenu()
		...
		loadout.frame:SetTitle( "ZentoTTT's Loadouts" )
